    ...
    <div className="flex flex-col items-center my-4 text-gray600 font-medium">
      ...
      <div className="flex flex-col sm:flex-row mx-auto justify-center items-center w-9/12 mb-8">
        ...
        <div className="text-container my-8 sm:pr-12">
          ...
          <div className="my-auto text-justify text-lg font-normal">
            Using magnetic field therapy, a current is induced in the cell which
            causes a contraction of the pelvic floor muscles. This strengthening
            of the muscles leads to improvement of incontinence problems.
            ContiCure offers the appropriate treatment parameters for each
            patient. Select the treatment goal from one of the 4 predefined
            programmes. This enables treatment of stress, mixed, and urge
            incontinence, and general pelvic floor training can be selected.
            ContiCure has a large applicator which is inserted in the treatment
            chair for the therapy. The intensity can be individually adjusted
            during therapy depending on the patient’s sensation.
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-lightgray">
        <div className="w-9/12 mx-auto py-24">
          <h1 className="text-5xl">Meet the next generation of Body Toning</h1>
          ...
          <div className="mb-2">
            ...
            <p className="font-light">
              ...
              depending on the programme. However, the user also has the option
              to create individual programmes for the patient in order to
              address the patient’s needs in a targeted manner.
            </p>
          </div>
          <div className="mb-2">
            ...
            <p className="font-light">
              ...
              muscles are optimally stimulated during the entire treatment time.
            </p>
          </div>
          <div className="mb-2">
            <h2 className="font-medium">Treatment recommendation</h2>
            <p className="font-light">
              Depending on the patient, between 8-10 treatments are recommended.
              Some patients report an improvement in their incontinence problems
              after just the first few treatments.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col sm:flex-row">
            <div>
              <div>
                ...
                <p className="font-light">
                  The sitting position can be adjusted using the three different
                  inlays, depending on the patient’s size.
                </p>
            ...
            <div>
              <div>
                ...
                <p className="font-light">Control knob to adjust intensities</p>
                <h2 className="font-semibold">Predefined protocols</h2>
                <p className="font-light">
                  Predefined protocols for the professional treatment of stress,
                  urge, and mixed incontinence as well as general pelvic floor
                  training are available to the user.
                </p>
