      ...
      <div className="flex flex-col sm:flex-row mx-auto justify-center items-center w-9/12 mb-8">
        ...
        <div className="text-container my-8 sm:pr-12">
          ...
          <div className="my-auto text-justify text-lg font-normal">
            ...
            vessels which is crucial for a high level of patient acceptance and
        ...
        <div className="w-9/12 mx-auto py-24">
          ...
          <div>
            ...
            <p className="font-light">
              ...
              successfully combined with PRP applications, vacuum pumps or also
              PDE-5 inhibitors (vasodilators), among others. The application is
              also virtually painless and has no known adverse effects.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-9/12 mx-auto py-24">
          ...
          <div>
            <p className="my-2 font-normal">
              Since the male penis is not a muscle, good perfusion of the corpus
              cavernosum is extremely important and significantly contributes to
              the male erection.
            </p>
            <p className="my-2 font-normal">
              With shockwave treatment, it is possible to significantly promote
              increased perfusion and stimulate the formation of new vascular
              structures at the same time. The radial shockwaves, which are
              emitted on the shaft of the penis as well as on the area around
              the genitals, support the natural stimulation of the area to be
              treated, particularly in the case of erectile dysfunction due to
              vascular causes. Even patients with severe erectile dysfunction
              who are taking so-called PDE-5 inhibitors achieve significantly
          ...
          <div className="flex sm:flex-row flex-col py-8">
            ...
            <div>
              ...
              <ul className="list-disc ml-6 mb-4 py-2">
                ...
                <li className="mb-1">
                  {" "}
                  promotes the development of new blood vessels (neoangiogensis)
                </li>
          ...
          <div className="flex">
            <div>
              ...
              <div>
                ...
                <p className="font-light">
                  12″ colour touch-screen for all software operations, knops for
                  energy and frequency. Handpiece operation via multidirectional
                  foot switch.
                </p>
              </div>
              <div>
