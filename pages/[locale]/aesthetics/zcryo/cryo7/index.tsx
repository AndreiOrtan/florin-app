    ...
    <div className="flex flex-col items-center my-4 text-gray600 font-medium">
      ...
      <div className="flex flex-col sm:flex-row mx-auto justify-center items-center w-9/12 mb-8">
        ...
        <div className="text-container my-8 sm:pr-12">
          ...
          <div className="my-auto text-justify text-lg">
            ...
            methods, such as contact cooling, cooling sprays, or ice packs, the
            skin can be cooled with Cryo before, during, and after the laser
            application without impeding the effect of the laser.
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-lightgray">
        <div className="w-9/12 mx-auto py-8">
          ...
          <p className="pt-4">
            Operating the new Cryo 7 entails only low consumption costs for you.
            The new standby mode additionally minimises energy costs.
          </p>
          <p className="pt-4">
            Cryo 7 is designed for reliable use all day long. The defrosting
            function and software-controlled monitoring of the amount of defrost
            water ensure smooth operation. In addition, the air filter is easily
            accessible and can be quickly replaced if soiled.
          </p>
          <p className="pt-4">
            Numerous technical innovations allow the Cryo 7 to be operated even
            more quietly. This makes the treatment significantly more pleasant
            for everyone: for your patients and also for the medical staff.
          </p>
        </div>
      </div>
      ...
      <div className="w-full">
        <div className="w-9/12 mx-auto py-8">
          ...
          <div>
            <h1 className="text-4xl font-semibold mb-4">Form meets function</h1>
        ...
        <div className="w-9/12 mx-auto py-8">
          ...
          <div className="flex">
            <div>
              ...
              <div>
                <h2 className="font-semibold pb-0.5">Eco standby operation</h2>
