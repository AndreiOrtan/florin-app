      ...
      <div className="flex flex-col sm:flex-row mx-auto justify-center items-center w-9/12 mb-8">
        ...
        <div className="text-container my-8 sm:pr-12">
          ...
          <div className="my-auto text-justify text-lg font-normal">
            ...
            moderate and deep nasolabial folds. It fills the moisture depots and
            rejuvenates the skin through long-lasting hydration. With Z Fill
            contour⁺ you correct wrinkles and increase lip volume.
          </div>
        </div>
      </div>
