      ...
      <div className="flex flex-col sm:flex-row mx-auto justify-center items-center w-9/12 mb-8">
        ...
        <div className="text-container my-8 sm:pr-12">
          ...
          <div className="my-auto text-justify text-lg font-normal">
            ...
            non-invasively. This method cools fat deposits over a longer period
            of time to a controlled and safe temperature range. ZLipo convinces
            with its simple, safe and user-friendly handling.
          </div>
        </div>
      </div>
        ...
        <div className="w-9/12 mx-auto py-8">
          <div>
            ...
            <p className="font-light">
              For years, Cryolipolysis™ has been successfully used to reduce fat
              deposits on thighs, hips, belly, buttocks, love handles, and men‘s
              chests. The targeted removal of energy by means of a cold
              treatment causes the apoptosis of the fat cells. This ultimately
              leads to their destruction. The complete breakdown and removal of
              fat cells the natural way through the lymphatic system takes about
              10–12 weeks. Since the surrounding tissue does not respond to the
              cold treatment in the same way as fatty tissue, the treatment is
              considered safe, gentle and non-invasive.
            </p>
          </div>
          <img
      ...
      <div className="w-full">
        <div className="w-9/12 mx-auto py-8">
          <div>
            ...
            <p className="font-light">
              The applicator for the ZLipo system comes in three sizes to apply
              pain-less suction to the desired treatment area. The ability to
              use pulsating suction increases the positive effect on lymphatic
              drainage and metabolism. The intensity can be set to one of ten
              different levels that can even be adjusted during treatment.
            </p>
            <p className="font-light mt-4">
              The large 10.2“ touch-screen colour display allows users to adjust
              the application time, suction level and suction mode (continuous
              or pulsed) safely and intuitively. The selected parameters are
              clearly displayed during treatment.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-9/12 mx-auto py-8">
          <div className="flex flex-col items-center py-24">
            ...
            <p className="font-light my-2">
              By combining ZLipo and ZWave Pro (Cryolipolysis™ and shockwave) we
              offer the perfect combination treatment for significantly better
              fat reduction. Studies and reports have shown that intensive,
              pain-free shockwave treatment after Cryolipolysis™ not only
              ensures better fat loss, but also stimulates lymphatic drainage
              and tightens the skin. The world’s leading operators have been
              using this concept for a long time.
            </p>
            <div className="videos flex flex-col sm:flex-row items-center justify-center">
              <iframe
          ...
          <div className="flex">
            <div>
              ...
              <div>
                ...
                <p className="font-light">10.2“ touch-screen colour display</p>
              </div>
              <div>
                <h2 className="font-semibold pb-0.5">Applicators</h2>
                <p className="font-light">
                  applicators available in size S, M and L and with 360° cooling
                  in sizes mini, S and M
                </p>
              </div>
              <div>
