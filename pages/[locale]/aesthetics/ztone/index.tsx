    ...
    <div className="flex flex-col items-center my-4 text-gray600 font-medium">
      ...
      <div className="flex flex-col sm:flex-row mx-auto justify-center items-center w-9/12 mb-8">
        ...
        <div className="text-container my-8 sm:pr-12">
          ...
          <div className="my-auto text-justify text-lg font-normal">
            ...
            bones without deformation or loss, activate the electrochemistry of
            tissues and improve the function of cells and cell membranes. The
            magnetic field consequently stimulates nerve cells, muscles and
            blood vessels.
          </div>
        </div>
      </div>
      <div className="w-full bg-lightgray">
        <div className="w-9/12 mx-auto py-24">
          ...
          <div>
            <p>
              Z Tone enables the user to select one of 3 desired training levels
              for each region appropriately for the patient.
            </p>
            <p>
              Z Tone has two applicators of the same size. Both applicators can
              be individually controlled and operated. This feature allows the
              user to treat two different regions with different intensities at
              the same time. The device also offers the option of connecting the
              applicators and operating them at the same intensity.
            </p>
          </div>
        </div>
      </div>
      <div className="w-full">
        <div className="w-9/12 mx-auto py-24">
          ...
          <div>
            <p>
              Z Tone has two applicators of the same size. Both applicators are
              used at the same time with identical application parameters or
              separately from each other. All relevant treatment parameters can
              be set, saved and adjusted with a few clicks. Z Tone allows
          ...
          <div className="flex sm:flex-row flex-col py-8">
            ...
            <div>
              ...
              <ul className="list-disc ml-6 mb-4 py-2">
                ...
                <li className="mb-1">
                  {" "}
                  Practical applicator holder always close to the treatment area{" "}
                </li>
              </ul>
            </div>
            <div>
              <h2 className="font-semibold text-lg">Maintenance-friendly</h2>
              <h2 className="font-normal text-base">Time for the essentials</h2>
              <ul className="list-disc ml-6 mb-4 py-2">
                <li className="mb-1">
                  {" "}
