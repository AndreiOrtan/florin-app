      ...
      <div className="flex flex-col items-center my-4 text-gray600 font-medium w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center mb-8">
              ...
              <div className="sm:ml-16 mt-8 sm:mt-0">
                ...
                <p className="font-light">
                  {t("general.lungime")} 180cm / {t("general.latime")} 100 cm /
        ...
        <div className="w-full">
          <div className="w-9/12 mx-auto py-8">
            ...
            <h1 className="font-medium mb-2">{t("dinamometre.card4.p1")}</h1>
            <div>
              <h1 className="font-bold mb-1">{t("dinamometre.card4.p2")}</h1>
              <ul className="list-disc ml-6">
                <li> {t("dinamometre.card4.p3")}</li>
                <li> {t("dinamometre.card4.p4")}</li>
                <li> {t("dinamometre.card4.p5")}</li>
                <li> {t("dinamometre.card4.p6")}</li>
                <li> {t("dinamometre.card4.p7")}</li>
                <li> {t("dinamometre.card4.p8")}</li>
                <li> {t("dinamometre.card4.p9")}</li>
                <li> {t("dinamometre.card4.p10")}</li>
                <li> {t("dinamometre.card4.p11")}</li>
                <li> {t("dinamometre.card4.p12")}</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="w-9/12 mx-auto py-8">
            <div className="flex flex-col justify-center items-center">
              <div className="flex sm:flex-row flex-col items-center">
                <div>
                  <h2 className="mb-1">{t("dinamometre.card4.p14")}</h2>
                  <p className="py-1 font-light">
                    {t("dinamometre.card4.p15")}
                  </p>
                </div>
                <Image
              ...
              <div className="flex sm:flex-row flex-col items-center">
                <div>
                  <h2 className="mb-1">{t("dinamometre.card4.p16")}</h2>
                  <p className="py-1 font-light">
                    {t("dinamometre.card4.p17")}
                  </p>
                </div>
                <Image
