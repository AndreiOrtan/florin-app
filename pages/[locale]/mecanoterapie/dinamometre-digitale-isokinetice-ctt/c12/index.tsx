      ...
      <div className="flex flex-col items-center my-4 text-gray600 font-medium w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center mb-8">
              ...
              <div className="sm:ml-16 mt-8 sm:mt-0">
                ...
                <p className="font-light">
                  {t("general.lungime")} 90cm / {t("general.latime")} 90cm /
                  {t("general.inaltime")} 200cm
                </p>
        ...
        <div className="w-full">
          <div className="w-9/12 mx-auto py-8">
            ...
            <h1 className="font-medium mb-2">{t("dinamometre.card5.p1")}</h1>
            <div>
              <h1 className="font-bold mb-1">{t("dinamometre.card5.p2")}</h1>
              <ul className="list-disc ml-6">
                <li> {t("dinamometre.card5.p3")}</li>
                <li> {t("dinamometre.card5.p4")}</li>
                <li> {t("dinamometre.card5.p5")}</li>
                <li> {t("dinamometre.card5.p6")}</li>
                <li> {t("dinamometre.card5.p7")}</li>
              </ul>
            </div>
          </div>
        </div>
