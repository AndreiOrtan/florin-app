      ...
      <div className="flex flex-col items-center my-4 text-gray600 font-medium w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center mb-8">
              ...
              <div className="sm:ml-16 mt-8 sm:mt-0">
                ...
                <p className="font-light">
                  {t("general.lungime")} 120cm / {t("general.latime")} 130 cm /
                  {t("general.inaltime")} 200 cm
                </p>
        ...
        <div className="w-full">
          <div className="w-9/12 mx-auto py-8">
            ...
            <h1 className="font-medium mb-2">{t("dinamometre.card8.p1")}</h1>
            <div>
              <h1 className="font-bold mb-1">{t("dinamometre.card8.p2")}</h1>
              <ul className="list-disc ml-6">
                <li> {t("dinamometre.card8.p3")}</li>
                <li> {t("dinamometre.card8.p4")}</li>
                <li> {t("dinamometre.card8.p5")}</li>
                <li> {t("dinamometre.card8.p6")}</li>
                <li> {t("dinamometre.card8.p7")}</li>
                <li> {t("dinamometre.card8.p8")}</li>
                <li> {t("dinamometre.card8.p9")}</li>
                <li> {t("dinamometre.card8.p10")}</li>
                <li> {t("dinamometre.card8.p11")}</li>
                <li>{t("dinamometre.card8.p12")}</li>
                <li> {t("dinamometre.card8.p13")}</li>
                <li> {t("dinamometre.card8.p14")}</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="w-9/12 mx-auto py-8">
            <div className="flex flex-col justify-center items-center">
              <div className="flex sm:flex-row flex-col items-center">
                <div>
                  <h2 className="mb-1">{t("dinamometre.card8.p17")}</h2>
                  <p className="py-1 font-light">
                    {t("dinamometre.card8.p18")}
                  </p>
                </div>
                <Image
