      ...
      <div className="flex flex-col items-center my-4 text-gray600 font-medium w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center mb-8">
              ...
              <div className="sm:ml-16 mt-8 sm:mt-0">
                ...
                <p className="font-light">
                  {t("general.lungime")} 240 cm / {t("general.latime")} 135 cm /
        ...
        <div className="w-full">
          <div className="w-9/12 mx-auto py-8">
            ...
            <h1 className="font-medium mb-2">{t("dinamometre.card3.p1")}</h1>
            <div>
              <h1 className="font-bold mb-1">{t("dinamometre.card3.p2")}</h1>
              <ul className="list-disc ml-6">
                <li> {t("dinamometre.card3.p3")}</li>
                <li> {t("dinamometre.card3.p4")}</li>
                <li> {t("dinamometre.card3.p5")}</li>
                <li> {t("dinamometre.card3.p6")}</li>
                <li> {t("dinamometre.card3.p7")}</li>
                <li> {t("dinamometre.card3.p8")}</li>
                <li> {t("dinamometre.card3.p9")}</li>
                <li> {t("dinamometre.card3.p10")}</li>
                <li> {t("dinamometre.card3.p11")}</li>
                <li> {t("dinamometre.card3.p12")}</li>
                <li> {t("dinamometre.card3.p13")}</li>
                <li> {t("dinamometre.card3.p14")}</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="w-9/12 mx-auto py-8">
            <div className="flex flex-col justify-center items-center">
              <div className="flex sm:flex-row flex-col items-center">
                <div>
                  <h2 className="mb-1">{t("dinamometre.card3.p16")}</h2>
                  <p className="py-1 font-light">
                    {t("dinamometre.card3.p17")}
                  </p>
                </div>
                <Image
              ...
              <div className="flex sm:flex-row flex-col items-center py-8">
                <div>
                  <h2 className="mb-1">{t("dinamometre.card3.p18")}</h2>
                  <p className="py-1 font-light">
                    {t("dinamometre.card3.p19")}
                  </p>
                </div>
                <Image
              ...
              <div className="flex sm:flex-row flex-col items-center py-8">
                <div>
                  <h2 className="mb-1">{t("dinamometre.card3.p20")}</h2>
                  <p className="py-1 font-light">
                    {t("dinamometre.card3.p21")}
                  </p>
                </div>
                <Image
