      ...
      <div className="flex flex-col items-center my-4 text-gray600 font-medium w-full">
        ...
        <div className="w-full">
          <div className="w-9/12 mx-auto py-8">
            ...
            <h1 className="font-medium mb-2">{t("masiniIso.card15.p1")}</h1>
            <h1 className="font-medium mb-2">{t("masiniIso.card15.p2")}</h1>
          </div>
        </div>
            ...
            <div className="flex sm:flex-row flex-col-reverse justify-center items-center">
              <div>
                <p>
                  ...
                  <span className="font-light">{t("masiniIso.card15.p3")}</span>
                </p>
              </div>
              <Image
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="flex sm:flex-row flex-col justify-between items-center w-full my-8 ">
                <div className="text-center mx-16">
                  ...
                  />
                  <p className="font-bold">{t("masiniIso.card15.p4")}</p>
                </div>
                <div className="text-center mx-16">
                  <Image
                    ...
                    className="rounded-lg mx-auto py-4"
                  />
                  <p className="font-bold">{t("masiniIso.card15.p5")}</p>
                </div>
                <div className="text-center mx-16">
                  <Image
                    ...
                    className="rounded-lg mx-auto py-4"
                  />
                  <p className="font-bold">{t("masiniIso.card15.p6")}</p>
                </div>
              </div>
              <div>
                <p className="py-1">{t("masiniIso.card15.p7")}</p>
                <p className="py-1">{t("masiniIso.card15.p8")}</p>
                <p className="py-1">{t("masiniIso.card15.p9")}</p>
                <p className="py-1">{t("masiniIso.card15.p10")}</p>
              </div>
            </div>
          </div>
        </div>
